...
class VS_CNN(object):
  ...
  def _build_graph(self):
    ...
    self.keep_prob = tf.compat.v1.placeholder_with_default(1.0, shape=[], name='dropout_keep_prob')
  ...
  def load_initial_weights(self, session):
    weights_dict = dict(np.load(self.weights_path, encoding='bytes', allow_pickle=True).item())
